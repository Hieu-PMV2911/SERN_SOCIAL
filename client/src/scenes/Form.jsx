		...
		<Formik onSubmit={handleFormSubmit}
			...
			{({
				...
				<Forms onSubmit={handleSubmit}>
					<Box display="grid"
					gap = "30px" gridTemplateColumns="repeat(4, minmax(0,1fr)" sx={{"& > div":{ gridColumn: isNonMobile ? undefined : 'span 4'}}}>
						{isRegister &&(
							<>
								<TextField
									label="First Name"
					...
					<Box>
						...
						backgroundColor:palette.primary.main, color: palette.background.alt, "&:hover": {color: palette.primary.main}}}>
